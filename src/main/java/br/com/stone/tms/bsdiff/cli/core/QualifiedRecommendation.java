...
public class QualifiedRecommendation {
	 ...
	 */
	public QualifiedRecommendation(MinimalZipEntry oldEntry, MinimalZipEntry newEntry, Recommendation recommendation,
	...
	public String toString() {
		return "QualifiedRecommendation [oldEntry=" + oldEntry.getFileName() + ", newEntry=" + newEntry.getFileName()
