...
import br.com.stone.tms.bsdiff.cli.shared.DeltaFriendlyFile;
...
public class PreDiffExecutor {
	  ...
	  private PreDiffPlan generatePreDiffPlan() throws IOException {
	    ...
	    for (DefaultDeflateCompressionDiviner.DivinationResult divinationResult : diviner.divineDeflateParameters(originalNewFile)) {
	      ByteArrayHolder key =
